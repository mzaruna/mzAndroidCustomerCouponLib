...
//
//        Call<LoginResponse> loginResponseCall= ApiClient.getLoginService(loginRequest).userLogin();
...
//        params.put("status", "R");
//
//        Call<SerialResponse> serialResponseCall= ApiClient.getSerialServices("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IkhEQ0s1UkhCN0ZGSldUV1ciLCJwYXNzd29yZCI6IjlRN1UiLCJpYXQiOjE2NTE4MTQ2MTgsImV4cCI6MTY1MTg0MzQxOH0.deoYG-WEkSmEpVDA1KpDXmmPDjcNJcpEBZ7g4k0zZkY").getSerialResponseByCustomerId("CFNE6Q",params);
...
//
//
//        Call<SerialResponse> serialResponseCall= ApiClient.getSerialServices("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ik9MVE1GMyIsInBhc3N3b3JkIjoiOHF5dSIsImlhdCI6MTY1MTgxOTU5MiwiZXhwIjoxNjUxODQ4MzkyfQ.RUkdCHXNG9VEoiV79ED1Kdh9lyeW7eKEEwQ3PLlEpVY").getSerialHistoryListByCustomerId("PNCEUL",params);
//        serialResponseCall.enqueue(new Callback<SerialResponse>() {
//            @Override
//            public void onResponse(Call<SerialResponse> call, Response<SerialResponse> response) {
//                Log.e("TAG", "onResponse: "+response.body().toString());
